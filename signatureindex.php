...
/**
 *	\file       signature/signatureindex.php
 *	\ingroup    signature
 *	\brief      Home page of signature top menu
 */
...
$langs->loadLangs(array("signature@signature"));

$action = GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->signature->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("SignatureArea"));

print load_fiche_titre($langs->trans("SignatureArea"), '', 'signature.png@signature');
...
// Draft MyObject
if (! empty($conf->signature->enabled) && $user->rights->signature->read)
{
	$langs->load("orders");
